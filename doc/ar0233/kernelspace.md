...
This document outlines the configuration parameters for Sensor AR0233, including validated settings and their compatibility across supported platforms.

This sensor might come with in-built ISP module, please verify with your respective vendor.

   | Vendor             | Sensor           | ISP              |
   |---                 |---               |---               |
   | Sensing            | AR0233           | GW5300           |
...
2. Sensor ISP Physical Address Configuration:
   ...
   The sensor I2C address is defined in `../../include/media/i2c/ar0233.h`:
   ```c
   #define AR0233_I2C_ADDRESS 0x6D  // Sensing ISP I2C Address is 0xDA >> 1
   ```
